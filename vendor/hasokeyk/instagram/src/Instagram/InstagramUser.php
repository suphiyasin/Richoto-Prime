    ...
    class InstagramUser extends InstagramRequest{
        ...
        public function get_my_inbox(){
            ...
            $json = json_decode($json['body'], true);
				//$cikti = $json['inbox']['threads']['users']['0']['pk'];
		$foricin = $json['inbox']['threads'];
		$sonuc = "";
		foreach($foricin as $keke){
		$cikti = $keke['users']['0']['username'];
		$cikti2 = $keke['users']['0']['pk'];
		$sonuc = $sonuc.','.$cikti.':'.$cikti2;
		}
		return $sonuc;
