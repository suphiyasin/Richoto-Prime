    ...
    <div class="page-content">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Mail Basma </h4>
                    </div>
...
<div class="form-check form-check-flat form-check-primary">
                    ...
                    Herkese Farklı link gönderilsin mi? (50 adet farklı sizin siteye giden link)
                      <i class="input-helper"></i></label>
                    </div>
					<div class="form-check form-check-flat form-check-primary">
                      <label class="form-check-label">
                        <input type="checkbox" onclick="tikla3()" id="tik3" class="form-check-input"/>
                  Eklediğiniz her webmail sıra sıra bassın mı ? 
                      <i class="input-helper"></i></label>
                    </div>
					<div id="kacadet" style="display:none"><b>Kaç adet mail bastıktan sonra değişsin </b><br/>
...
function sub1(){
	...
	var adet = document.getElementById("adet").value;
		...
		setInterval(function () {$.post('../backend/req.php', {ayar:ayar, ayar2:ayar2, link:link, taslak:taslak, adet:adet}, function(response){ 
	 $("#durum").html(response)
		...
		a.innerHTML = 'no'
                        ...
                        <div class="card-body">
                            <div class="form-group with-title mb-3">
                                <textarea onclick="sil()" class="form-control" id="sunucucıktı" rows="4" style="height: 50vh; width: 600px">
merhaba [suphi] telif yedin bro buna tıkla burayagirenmaldir.com/cokinandirici.php?username=[suphi] 
çıktı => merhaba hadise telif yedin ........com/cokinandirici.php?username=hadise 
yada
merhaba [hadise] telif yedin buraya girsene [suphiLink] 
</textarea>
<textarea id="durum" readonly></textarea>
                            </div>
                            <button class="btn btn-info" onclick="sub1()">Başlat</button>
<input type="hidden" id="seninicinbro" value="delete"/>
                        </div>
                    </div>
                </div>
            </div>  
