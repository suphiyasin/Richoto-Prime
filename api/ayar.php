        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
             ...
             <?php include("../backend/files/notf.php"); ?>
            </div>
          </li>
       ...
       <div class="content-wrapper">
          <div class="row">
            <div class="col-md-20 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Oto Ayarları</h4>
                  <p class="card-description">
                    İnstagram hesabı eklemek  icin kullanın.
                  </p>
                  
                    <div class="form-group">
                      <label for="exampleInputUsername1">İnstagram Kullanıcı Adınız</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Username">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Sifreniz</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Password">
                    </div>
                   
                    
                    <button onclick="sub1()" class="btn btn-primary mr-2">Kaydet</button><br/>
                    <div id="adas"></div>
                  <script>
				  function sub1(){
					  var ayar = "hesapekle";
					  var veri = document.getElementById("exampleInputUsername1").value;
					  var veri2 = document.getElementById("exampleInputEmail1").value;
				  $.post('../backend/req.php', {ayar:ayar, veri:veri, veri2:veri2}, function(response){ 
	 $("#adas").html(response)
            ...
            <div class="col-md-20 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Oto Ayarları</h4>
                  <p class="card-description">
                    Webmail Smtpn Bilgileriniz icin kullanın. 
                  </p>
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="exampleInputEmail1" placeholder="">
				                    ...
				                    <div class="form-group">
                      <label for="exampleInputEmail1">Kimden</label>
                      <input type="email" class="form-control" id="exampleInputEmail1" placeholder="">
                    </div>
                    <div class="form-group">
