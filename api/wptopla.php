      ...
      <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Whatsapp Toplayıcı</h4>
                  <p class="card-description">
                    Kullanıcı Adını Girdiğiniz Hesabın onerılerı toplar.
                  </p>
                  <form class="forms-sample">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Önerileri Toplanacak Hesap</label>
		  ...
		  <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Wp Toplama </h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <div class="form-group with-title mb-3">
                                <textarea class="form-control" id="toplananhesaplar" rows="8"></textarea>
                                <label id="toplananhesaptext">Toplanan Numaralar</label>
                            </div>

                            <button class="btn btn-info" >Toplamayı Durdur</button>
